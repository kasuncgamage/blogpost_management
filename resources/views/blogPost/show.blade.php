        ...
        <div class="col-md-12">
            ...
            <div class="card p-2">
                <div class="mb-3">
                    ...
                    <input disabled type="text" class="form-control" id="blog_post_title" name="blog_post_title" placeholder="title" value="{{ $blogPost->blog_post_title }}">
                </div>

                <div class="mb-3">
                    <label for="blog_post_content" class="form-label">Content:</label>
                    <textarea disabled class="form-control date" id="blog_post_content" name="blog_post_content" placeholder="content">{{ $blogPost->blog_post_content }}</textarea>
                </div>


                <div class="mb-3">
                    <label for="blog_post_publish_date" class="form-label">Publish Date:</label>
                    <input disabled type="date" class="form-control" id="blog_post_publish_date" name="blog_post_publish_date" value="{{ $blogPost->blog_post_publish_date }}">
                </div>

                <div class="mb-3">
                    <label for="post_type_id" class="form-label">Post Type{{$blogPost->post_type_id}}</label>
                    <select disabled class="form-select" name="post_type_id" id="post_type_id">
